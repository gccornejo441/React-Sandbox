...
export const Navbar = () => {
  ...
  return (
    <HeroUINavbar maxWidth="xl" position="sticky" className="border-b border-[var(--border)]">
      <NavbarContent className="basis-1/5 sm:basis-full" justify="start">
        <NavbarBrand className="gap-3 max-w-fit">
          <Link
            ...
            href="/"
          >
            <Logo className="h-6 text-[var(--color-secondary-light)] dark:text-white" />
          </Link>
        </NavbarBrand>
      ...
      >
        ...
        {/* Conditionally show login/signup if not authenticated */}
        {!isAuthenticated && (
